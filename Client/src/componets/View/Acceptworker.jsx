...
export default function Acceptworker() {
    const [accept, setAccept] = useState([])
    console.log(accept);
    useEffect(() => {
      const workerId=localStorage.getItem('login_id')
  
      axios.get(`http://localhost:4000/workeraccept/view-workeraccept-booking/${workerId}`).then((response)=> {
    ...
    <div className="row align-items-end mb-4">
      <div className="col-lg-6">
        ...
        <h1 className="section-title mb-3">
          Here you can see the workers who have accepted your job
        </h1>
      </div>
      <div className="col-lg-6">
    ...
    <div className="row">
      <div className="col-lg-4 col-md-6 mb-5">
       ...
       contact:{data.contact} 
        ...
        <Link className="btn btn-sm btn-primary py-2" to={`/feedback/${data._id}`}>Add feedback</Link>
      </div>
